        ...
        <form onSubmit={handleSubmit(doSubmit)}>
            <Stack direction={{ base: 'column', md: 'row' }} gap='4'>
                ...
                <Flex direction='column' flex='1' gap='4'>
                    ...
                    <FormControl isInvalid={errors.spentTime}>
                        <Input
                            id="spentTime"
                            type="number"
                            step="0.1"
                            placeholder="Потраченные часы"
                            {...register("spentTime", {
                                required: "Time spent is required",
                                valueAsNumber: true,
                                validate: value => value > 0 || "Время должно быть больше 0",
                            })}
                        />
                        <FormErrorMessage>
                            {errors.spentTime && errors.spentTime.message}
                        </FormErrorMessage>
                    </FormControl>
